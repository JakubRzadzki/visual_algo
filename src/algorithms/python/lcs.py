...
def solve_lcs(text1, text2):
    ...
    emit(
        "SYSTEM_LOG",
        message=f"Initializing Longest Common Subsequence matrix for sequences '{text1}' and '{text2}'.",
        level="INFO",
    )
    ...
    emit(
        "SYSTEM_LOG",
        message=f"LCS Computation complete. Length of Longest Common Subsequence is {dp[m][n]}.",
        level="INFO",
    )
