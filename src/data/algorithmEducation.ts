...
export const ALGORITHM_EDUCATION: Record<string, AlgorithmEducation> = {
  "merge-sort": {
    ...
    theory_pl:
      "Sortowanie przez scalanie (Merge Sort) to klasyczny, stabilny algorytm sortowania oparty na paradygmacie „dziel i zwyciężaj” (Divide and Conquer), opracowany przez wybitnego matematyka Johna von Neumanna w 1945 roku.\n\nAlgorytm działa poprzez rekurencyjny podział nieuporządkowanej tablicy na coraz mniejsze podtablice, aż do osiągnięcia pojedynczych elementów. Następnie rozpoczyna się kluczowa faza scalania (merge), w której sąsiednie, uporządkowane podtablice są łączone w jedną, większą i w pełni posortowaną strukturę.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy tablicę wejściową `[38, 27, 43, 3, 9, 82, 10]`:\n1. **Faza podziału (Split):**\n   - Tablica dzielona jest na pół: `[38, 27, 43, 3]` oraz `[9, 82, 10]`.\n   - Lewa część dzielona na: `[38, 27]` oraz `[43, 3]`.\n   - Podtablice dwuelementowe dzielone są na pojedyncze elementy: `[38]`, `[27]` oraz `[43]`, `[3]`.\n   - Prawa część `[9, 82, 10]` dzielona jest na `[9]` oraz `[82, 10]`, a ta druga na `[82]` i `[10]`.\n2. **Faza scalania (Merge):**\n   - Scalamy `[38]` i `[27]`. Porównujemy 38 i 27. Ponieważ `27 < 38`, wynik to `[27, 38]`.\n   - Scalamy `[43]` i `[3]`. Ponieważ `3 < 43`, wynik to `[3, 43]`.\n   - Scalamy `[27, 38]` i `[3, 43]`. Porównujemy pierwsze elementy: 27 i 3 -> bierzemy 3. Porównujemy 27 i 43 -> bierzemy 27. Porównujemy 38 i 43 -> bierzemy 38. Zostaje 43. Wynik: `[3, 27, 38, 43]`.\n   - Po prawej stronie scalamy `[82]` i `[10]` -> `[10, 82]`. Scalamy `[9]` i `[10, 82]` -> porównujemy 9 i 10 -> bierzemy 9, zostaje `[10, 82]`. Wynik: `[9, 10, 82]`.\n   - **Ostateczne scalenie** lewej `[3, 27, 38, 43]` i prawej `[9, 10, 82]`:\n     - Porównujemy 3 i 9 -> 3\n     - Porównujemy 27 i 9 -> 9\n     - Porównujemy 27 i 10 -> 10\n     - Porównujemy 27 i 82 -> 27\n     - Porównujemy 38 i 82 -> 38\n     - Porównujemy 43 i 82 -> 43\n     - Przepisujemy 82.\n   - Ostateczny wynik: `[3, 9, 10, 27, 38, 43, 82]`.\n\nZłożoność obliczeniowa algorytmu wynosi stabilne O(n log n) we wszystkich trzech przypadkach (pesymistycznym, średnim oraz optymistycznym), co czyni go niezwykle przewidywalnym. Główną wadą jest jednak złożoność pamięciowa O(n), wynikająca z konieczności alokacji dodatkowego obszaru pamięci na scalane fragmenty.",
    history:
  ...
  "quick-sort": {
    ...
    theory_pl:
      "Sortowanie szybkie (Quick Sort) to jeden z najpopularniejszych i najbardziej efektywnych algorytmów sortowania opartych na porównaniach, zaprojektowany przez Tony'ego Hoare'a w 1959 roku. Działa w oparciu o zasadę „dziel i zwyciężaj”. Cała ciężka praca wykonywana jest na etapie podziału (partitioning), a scalanie jest zbędne, gdyż operacje odbywają się bezpośrednio w oryginalnej pamięci tablicy (in-place).\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy tablicę `[38, 27, 43, 3, 9, 82, 10]`, w której jako element osiowy (pivot) wybieramy zawsze ostatni element: **10** (indeks 6):\n1. **Faza Partycjonowania (Partition):**\n   - Inicjalizujemy wskaźnik granicy mniejszych elementów `i = -1`.\n   - Iterujemy od `j = 0` do `5`:\n     - `j = 0` (38): `38 > 10` -> brak zmian.\n     - `j = 1` (27): `27 > 10` -> brak zmian.\n     - `j = 2` (43): `43 > 10` -> brak zmian.\n     - `j = 3` (3): `3 <= 10` -> zwiększamy `i` do 0, zamieniamy `arr[0]` (38) z `arr[3]` (3). Tablica: `[3, 27, 43, 38, 9, 82, 10]`.\n     - `j = 4` (9): `9 <= 10` -> zwiększamy `i` do 1, zamieniamy `arr[1]` (27) z `arr[4]` (9). Tablica: `[3, 9, 43, 38, 27, 82, 10]`.\n     - `j = 5` (82): `82 > 10` -> brak zmian.\n   - Na koniec zamieniamy pivot `10` z elementem stojącym za granicą mniejszych, czyli `arr[i+1]` (43 na indeksie 2). Tablica: `[3, 9, 10, 38, 27, 82, 43]`.\n   - W tym momencie element **10** znajduje się na swoim ostatecznym, idealnym miejscu.\n2. **Wywołania rekurencyjne:**\n   - Lewa podtablica `[3, 9]` jest sortowana analogicznie (pivot 9, granica stawia 3 na lewo, 9 zostaje na miejscu).\n   - Prawa podtablica `[38, 27, 82, 43]` wybiera pivot **43**:\n     - Elementy mniejsze od 43 (`38`, `27`) są grupowane po lewej stronie, `82` po prawej. Po zamianie pivota tablica to `[38, 27, 43, 82]`.\n     - Rekurencja sortuje `[38, 27]` (zamieniając na `[27, 38]`).\n   - Cała tablica staje się idealnie uporządkowana: `[3, 9, 10, 27, 38, 43, 82]`.\n\nŚrednia oraz optymistyczna złożoność obliczeniowa Quick Sort wynosi O(n log n). W najgorszym scenariuszu złożoność degraduje się do O(n²). Algorytm ten jest niestabilny, ale ze względu na bardzo mały narzut pamięciowy O(log n) oraz doskonałe wykorzystanie pamięci podręcznej procesora (cache locality), jest w praktyce znacznie szybszy od wielu innych algorytmów.",
  ...
  "bubble-sort": {
    ...
    theory_pl:
      "Sortowanie bąbelkowe (Bubble Sort) to jeden z najprostszych i najbardziej intuicyjnych algorytmów sortowania. Jego nazwa wywodzi się z faktu, że większe (lub cięższe) elementy w tablicy podczas kolejnych przejść pętli stopniowo „wypływają” (przesuwają się) na koniec struktury, zupełnie jak bąbelki powietrza w wodzie.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy tablicę `[5, 1, 4, 2, 8]`:\n1. **Przejście 1:**\n   - Porównujemy `5` i `1`. Ponieważ `5 > 1`, zamieniamy je miejscami. Tablica: `[1, 5, 4, 2, 8]`.\n   - Porównujemy `5` i `4`. Ponieważ `5 > 4`, zamieniamy je miejscami. Tablica: `[1, 4, 5, 2, 8]`.\n   - Porównujemy `5` i `2`. Ponieważ `5 > 2`, zamieniamy je miejscami. Tablica: `[1, 4, 2, 5, 8]`.\n   - Porównujemy `5` i `8`. Ponieważ `5 < 8`, nie zamieniamy. Element **8** dotarł na sam koniec i jest posortowany.\n2. **Przejście 2:**\n   - Porównujemy `1` i `4` -> brak zamiany (`1 < 4`).\n   - Porównujemy `4` i `2` -> zamiana (`4 > 2`). Tablica: `[1, 2, 4, 5, 8]`.\n   - Porównujemy `4` i `5` -> brak zamiany.\n   - Element **5** jest na ostatecznej pozycji.\n3. **Przejście 3:**\n   - Porównujemy `1` i `2` -> brak zamiany.\n   - Porównujemy `2` i `4` -> brak zamiany.\n   - Element **4** jest na ostatecznej pozycji.\n4. **Przejście 4:**\n   - Brak jakichkolwiek zamian w całym przejściu oznacza, że tablica jest w pełni posortowana: `[1, 2, 4, 5, 8]`.\n\nPod względem wydajności algorytm ten jest skrajnie nieefektywny. Zarówno w przypadku średnim, jak i najgorszym, jego złożoność czasowa wynosi O(n²), co dyskwalifikuje go z jakichkolwiek profesjonalnych zastosowań dla dużych zbiorów danych. Jedyną zaletą jest optymistyczna złożoność O(n) (przy tablicy już posortowanej) oraz minimalna złożoność pamięciowa O(1).",
    history:
  ...
  "heap-sort": {
    ...
    theory_pl:
      "Sortowanie przez kopcowanie (Heap Sort) to zaawansowany algorytm sortowania oparty na porównaniach, który wykorzystuje strukturę danych zwaną kopcem binarnym (binary heap). Został zaproponowany przez J. W. J. Williamsa w 1964 roku. Kopiec to kompletne drzewo binarne, w którym spełniony jest tzw. warunek kopca – w przypadku kopca typu Max (Max-Heap), wartość każdego rodzica jest większa lub równa wartościom jego dzieci.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy wejściową tablicę `[4, 10, 3, 5, 1]`:\n1. **Faza 1: Budowanie Kopca typu Max (Heapify):**\n   - Reprezentacja drzewiasta: korzeń `4` ma dzieci `10` i `3`. Węzeł `10` ma dzieci `5` i `1`.\n   - Zaczynamy naprawianie kopca od ostatniego rodzica na indeksie 1 (wartość `10`). Dzieci to `5` i `1`. Ponieważ `10` jest większe od obu, warunek jest spełniony.\n   - Przechodzimy do korzenia na indeksie 0 (wartość `4`). Dzieci to `10` i `3`. Największe z dzieci to `10`. Zamieniamy `4` z `10` -> tablica `[10, 4, 3, 5, 1]`.\n   - Naprawiamy poddrzewo o nowym korzeniu `4` (indeks 1). Dzieci to `5` i `1`. Największe to `5`. Zamieniamy `4` z `5` -> tablica `[10, 5, 3, 4, 1]`.\n   - Kopiec typu Max został pomyślnie zbudowany (największy element `10` jest na korzeniu).\n2. **Faza 2: Usunięcie korzenia i naprawa (Sort):**\n   - Zamieniamy korzeń `10` z ostatnim elementem `1` -> tablica `[1, 5, 3, 4, 10]`. Element `10` zostaje odcięty od kopca (jest posortowany).\n   - Naprawiamy kopiec o rozmiarze 4: dla korzenia `1` dzieci to `5` i `3`. Zamieniamy `1` z `5` -> `[5, 1, 3, 4, 10]`.\n   - Dla węzła `1` (indeks 1) jedynym dzieckiem jest `4`. Zamieniamy `1` z `4` -> `[5, 4, 3, 1, 10]`.\n   - Zamieniamy korzeń `5` z ostatnim aktywnym elementem `1` -> `[1, 4, 3, 5, 10]`. `5` jest posortowane.\n   - Naprawiamy kopiec o rozmiarze 3: dla korzenia `1` dzieci to `4` i `3`. Zamieniamy `1` z `4` -> `[4, 1, 3, 5, 10]`.\n   - Zamieniamy korzeń `4` z ostatnim elementem `3` -> `[3, 1, 4, 5, 10]`.\n   - Naprawiamy kopiec o rozmiarze 2: dla korzenia `3` dziecko to `1`. `3 > 1` - brak zamiany.\n   - Zamieniamy `3` z `1` -> `[1, 3, 4, 5, 10]`. Ostatecznie otrzymujemy posortowaną tablicę.\n\nZłożoność czasowa Heap Sort wynosi gwarantowane O(n log n) we wszystkich przypadkach (najgorszym, średnim i najlepszym). Dodatkowo sortowanie odbywa się w miejscu (in-place) ze złożonością pamięciową O(1). Mimo znakomitych gwarancji teoretycznych, w praktyce bywa nieco wolniejszy od Quick Sort ze względu na gorszą lokalność pamięci podręcznej. Jest to algorytm niestabilny.",
    history:
  ...
  "binary-search": {
    ...
    theory_pl:
      "Wyszukiwanie binarne (Binary Search) to niezwykle efektywny algorytm wyszukiwania elementu w posortowanej tablicy. Wykorzystuje technikę „dziel i zwyciężaj”. Warunkiem koniecznym do działania algorytmu jest uprzednie posortowanie zbioru danych.\n\n**Analiza przykładu (Krok po kroku):**\nSzukamy wartości **43** w posortowanej tablicy `[3, 9, 10, 27, 38, 43, 82]`:\n1. **Krok 1:**\n   - Ustawiamy wskaźnik lewy `L = 0` oraz prawy `R = 6`.\n   - Obliczamy indeks środkowy: `M = floor((0 + 6) / 2) = 3`.\n   - Sprawdzamy wartość pod indeksem 3: `arr[3] = 27`.\n   - Ponieważ szukana wartość `43` jest większa niż `27`, odrzucamy lewą połowę tablicy wraz z elementem środkowym. Nowa granica lewa to `L = M + 1 = 4`.\n2. **Krok 2:**\n   - Nowy zakres wyszukiwania: `L = 4`, `R = 6`.\n   - Obliczamy nowy środek: `M = floor((4 + 6) / 2) = 5`.\n   - Sprawdzamy wartość pod indeksem 5: `arr[5] = 43`.\n   - Porównujemy: `43 == 43`. Nastąpiło dopasowanie! Wartość została znaleziona pod indeksem 5 po zaledwie 2 porównaniach (zamiast 6 przy wyszukiwaniu liniowym).\n\nWyszukiwanie binarne cechuje się fantastyczną złożonością czasową O(log n). Dla tablicy o rozmiarze miliona elementów algorytm potrzebuje maksymalnie 20 kroków (porównań), aby odnaleźć element lub stwierdzić jego brak. Złożoność pamięciowa w wersji iteracyjnej wynosi minimalne O(1).",
    history:
  ...
  "linear-search": {
    ...
    theory_pl:
      "Wyszukiwanie liniowe (Linear Search), nazywane również sekwencyjnym, to najbardziej podstawowa i intuicyjna metoda poszukiwania określonej wartości w zbiorze danych. W przeciwieństwie do wyszukiwania binarnego, wyszukiwanie liniowe nie wymaga żadnego wcześniejszego uporządkowania danych – może być stosowane na całkowicie chaotycznych listach.\n\n**Analiza przykładu (Krok po kroku):**\nSzukamy wartości **38** w tablicy `[3, 9, 10, 27, 38, 43, 82]`:\n1. **Krok 1:** Badamy indeks 0 (`arr[0] = 3`). `3 != 38` -> przechodzimy dalej.\n2. **Krok 2:** Badamy indeks 1 (`arr[1] = 9`). `9 != 38` -> przechodzimy dalej.\n3. **Krok 3:** Badamy indeks 2 (`arr[2] = 10`). `10 != 38` -> przechodzimy dalej.\n4. **Krok 4:** Badamy indeks 3 (`arr[3] = 27`). `27 != 38` -> przechodzimy dalej.\n5. **Krok 5:** Badamy indeks 4 (`arr[4] = 38`). `38 == 38` -> dopasowanie! Algorytm natychmiast przerywa pętlę i zwraca indeks 4. Sukces!\n\nZłożoność obliczeniowa w najgorszym scenariuszu wynosi O(n) – dzieje się tak, gdy szukany element znajduje się na samym końcu listy lub w ogóle w niej nie występuje. W najlepszym wypadku złożoność wynosi O(1), gdy trafimy na szukany obiekt już za pierwszym podejściem. Złożoność pamięciowa to stałe O(1).",
    history:
...
return -1`,
  ...
  dijkstra: {
    ...
    theory_pl:
      "Algorytm Dijkstry to klasyczny i jeden z najważniejszych algorytmów grafowych, opracowany przez holenderskiego pioniera informatyki Edsgera W. Dijkstrę w 1956 roku. Służy do znajdowania najkrótszych ścieżek z jednego wierzchołka źródłowego do wszystkich pozostałych wierzchołków w grafie ważonym. Kluczowym ograniczeniem algorytmu jest wymóg, aby wszystkie wagi krawędzi były nieujemne (waga w >= 0).\n\n**Analiza przykładu (Krok po kroku):**\nRozpatrzmy graf z wierzchołkami `A, B, C, D` połączonymi krawędziami o wagach:\n- `A-B` (waga 4)\n- `A-C` (waga 2)\n- `B-C` (waga 1)\n- `B-D` (waga 5)\n- `C-D` (waga 8)\n\nChcemy znaleźć najkrótsze ścieżki z wierzchołka startowego **A**:\n1. **Inicjalizacja:** Ustawiamy odległość do A jako 0, a do pozostałych wierzchołków jako nieskończoność (`inf`). `dist = {A: 0, B: inf, C: inf, D: inf}`.\n2. **Krok 1 (Wizytacja A):**\n   - Pobieramy wierzchołek o najmniejszej odległości -> `A` (`dist=0`).\n   - Relaksujemy krawędzie wychodzące z A:\n     - Sąsiad B: `dist[B] = min(inf, 0 + 4) = 4`.\n     - Sąsiad C: `dist[C] = min(inf, 0 + 2) = 2`.\n   - Oznaczamy A jako w pełni odwiedzony.\n3. **Krok 2 (Wizytacja C):**\n   - Następny nieodwiedzony o najmniejszej znanej odległości to `C` (`dist=2`).\n   - Relaksujemy krawędzie wychodzące z C:\n     - Sąsiad B: `dist[B] = min(4, dist[C] + 1) = min(4, 2 + 1) = 3`. (Dokonaliśmy skrótu ścieżki do B przez C! Nowy koszt to 3).\n     - Sąsiad D: `dist[D] = min(inf, dist[C] + 8) = 10`.\n   - Oznaczamy C jako odwiedzony.\n4. **Krok 3 (Wizytacja B):**\n   - Wybieramy nieodwiedzony o najmniejszym koszcie -> `B` (`dist=3`).\n   - Relaksujemy sąsiadów B:\n     - Sąsiad D: `dist[D] = min(10, dist[B] + 5) = min(10, 3 + 5) = 8`. (Kolejna relaksacja ścieżki do D!).\n   - Oznaczamy B jako odwiedzony.\n5. **Krok 4 (Wizytacja D):**\n   - Wybieramy `D` (`dist=8`). Wszystkie krawędzie sprawdzone.\n\nOstateczne najkrótsze odległości od A wynoszą odpowiednio: `A: 0, B: 3 (ścieżka A->C->B), C: 2 (ścieżka A->C), D: 8 (ścieżka A->C->B->D)`.\n\nWydajność algorytmu zależy od implementacji kolejki priorytetowej. Przy zastosowaniu kopca binarnego złożoność czasowa wynosi O((V + E) log V), gdzie V to liczba wierzchołków, a E to liczba krawędzi. Złożoność pamięciowa to O(V) na przechowywanie odległości i struktury kolejki.",
    history:
...
while queue:
  ...
  dfs: {
    ...
    theory_pl:
      "Przeszukiwanie w głąb (Depth-First Search - DFS) to jeden z fundamentalnych algorytmów przechodzenia grafów, którego korzenie sięgają prac francuskiego matematyka Charlesa Pierre'a Trémaux z XIX wieku nad metodami rozwiązywania labiryntów. DFS eksploruje graf, idąc tak głęboko, jak to tylko możliwe wzdłuż każdej gałęzi, zanim rozpocznie proces powrotu (backtracking) do ostatnich rozgałęzień.\n\n**Analiza przykładu (Krok po kroku):**\nRozpatrzmy ten sam graf: `A` połączone z `B` i `C`, `B` połączone z `D`, a `C` połączone z `E`. Startujemy z wierzchołka **A**:\n1. **Krok 1:** Odwiedzamy wierzchołek startowy `A`. Oznaczamy go jako odwiedzony. `Visited = {A}`. Na stosie ląduje wywołanie `DFS(A)`.\n2. **Krok 2:** Wybieramy pierwszego nieodwiedzonego sąsiada wierzchołka `A`, czyli `B`. Wywołujemy rekurencyjnie `DFS(B)`. Oznaczamy go. `Visited = {A, B}`.\n3. **Krok 3:** Będąc w `B`, szukamy jego nieodwiedzonego sąsiada. Jest nim `D`. Wywołujemy `DFS(D)`. Oznaczamy go. `Visited = {A, B, D}`.\n4. **Krok 4 (Backtrack):** Wierzchołek `D` nie ma żadnych innych sąsiadów. Zdejmujemy `DFS(D)` ze stosu i wracamy do `B`. Ponieważ `B` również nie ma innych nieodwiedzonych sąsiadów, wracamy do `A`.\n5. **Krok 5:** Będąc z powrotem w `A`, szukamy kolejnego nieodwiedzonego sąsiada. Jest nim `C`. Wywołujemy `DFS(C)`. Oznaczamy go. `Visited = {A, B, D, C}`.\n6. **Krok 6:** Będąc w `C`, idziemy do jego sąsiada `E`. Wywołujemy `DFS(E)`. Oznaczamy go. `Visited = {A, B, D, C, E}`.\n7. **Krok 7:** `E` nie ma dzieci -> wracamy do `C`, potem do `A`. Stos wywołań staje się pusty. Zakończyliśmy proces eksploracji.\n   - Kolejność przejścia grafu (w głąb): `A, B, D, C, E`.\n\nPodobnie jak BFS, złożoność czasowa DFS wynosi O(V + E), ponieważ odwiedzamy każdy wierzchołek i sprawdzamy każdą krawędź skończoną liczbę razy. Złożoność pamięciowa wynosi O(V) w najgorszym scenariuszu (np. gdy graf jest jedną długą ścieżką). DFS jest kluczowym elementem wielu zaawansowanych algorytmów, takich jak wykrywanie cykli, wyszukiwanie silnie spójnych składowych (algorytm Tarjana) czy sortowanie topologiczne.",
    history:
  ...
  "a-star": {
    ...
    theory_pl:
      "Algorytm A* (A-Star) to niezwykle popularny i wysoce wydajny algorytm wyszukiwania ścieżki w grafie, opracowany w 1968 roku w Stanford Research Institute przez Petera Harta, Nilsa Nilssona i Bertrama Raphaela. Stanowi on rozszerzenie algorytmu Dijkstry, wzbogacone o mechanizmy heurystyczne, co pozwala drastycznie zmniejszyć liczbę przeszukiwanych wierzchołków i skierować poszukiwania bezpośrednio w stronę celu.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy siatkę 2D, w której chcemy przejść z punktu startowego **S (0,0)** do celu **G (2,2)**. Pole `(1,1)` jest zablokowaną przeszkodą. Koszt każdego kroku (pionowo/poziomo) wynosi `g = 1`. Jako heurystykę `h` stosujemy odległość Manhattan: `h = |x - x_cel| + |y - y_cel|`:\n1. **Inicjalizacja:** Dodajemy punkt startowy `(0,0)` do listy otwartej (Open List). Koszt rzeczywisty `g((0,0)) = 0`. Szacowana odległość do celu: `h((0,0)) = |0-2| + |0-2| = 4`. Całkowity koszt szacowany: `f = g + h = 4`.\n2. **Iteracja 1:**\n   - Pobieramy z listy otwartej wierzchołek o najmniejszym `f` -> `(0,0)`. Przenosimy go do listy zamkniętej (Closed List).\n   - Badamy sąsiadów `(0,0)`:\n     - Sąsiad `(1,0)`: `g = 1`, `h = |1-2| + |0-2| = 3`, stąd `f = 1 + 3 = 4`. Dodajemy do listy otwartej.\n     - Sąsiad `(0,1)`: `g = 1`, `h = |0-2| + |1-2| = 3`, stąd `f = 1 + 3 = 4`. Dodajemy do listy otwartej.\n3. **Iteracja 2:**\n   - Wybieramy z listy otwartej element o najniższym `f` (remis, wybieramy `(1,0)` o `f=4`). Przenosimy do listy zamkniętej.\n   - Badamy sąsiadów `(1,0)`:\n     - `(2,0)`: `g = 2`, `h = |2-2| + |0-2| = 2`, stąd `f = 2 + 2 = 4`. Dodajemy do listy otwartej.\n     - `(1,1)` jest przeszkodą, więc go pomijamy.\n4. **Iteracja 3:**\n   - Wybieramy element o najniższym `f` -> `(2,0)` (f=4). Przenosimy do listy zamkniętej.\n   - Badamy sąsiadów `(2,0)`:\n     - `(2,1)`: `g = 3`, `h = |2-2| + |1-2| = 1`, stąd `f = 3 + 1 = 4`. Dodajemy do listy otwartej.\n5. **Iteracja 4:**\n   - Wybieramy `(2,1)` (f=4). Przenosimy do listy zamkniętej.\n   - Badamy sąsiadów `(2,1)`:\n     - Cel `(2,2)`: `g = 4`, `h = 0`, stąd `f = 4`. Osiągnęliśmy cel! Algorytm natychmiast kończy działanie i zwraca bezpośrednią ścieżkę: `(0,0) -> (1,0) -> (2,0) -> (2,1) -> (2,2)`.\n\nZłożoność obliczeniowa A* zależy od jakości heurystyki. Przy doskonałej heurystyce czas działania wynosi O(V), podczas gdy przy skrajnie nieskutecznej heurystyce (np. h(n) = 0) algorytm redukuje się do klasycznego algorytmu Dijkstry.",
    history:
...
while openList:
  ...
  kruskal: {
    ...
    theory_pl:
      "Algorytm Kruskala to zachłanny algorytm służący do znajdowania Minimalnego Drzewa Rozpinającego (Minimum Spanning Tree - MST) w spójnym, ważonym grafie nieskierowanym. Został opublikowany przez Josepha Kruskala w 1956 roku. MST to taki podgraf, który łączy wszystkie wierzchołki grafu bez tworzenia cykli, a suma wag jego krawędzi jest najmniejsza z możliwych.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy graf z wierzchołkami `A, B, C, D` i krawędziami:\n- `A-B` (waga 1)\n- `A-C` (waga 2)\n- `B-C` (waga 3)\n- `C-D` (waga 4)\n- `B-D` (waga 5)\n\n1. **Krok 1 (Sortowanie):** Układamy krawędzie w kolejności rosnących wag: `[A-B (1), A-C (2), B-C (3), C-D (4), B-D (5)]`.\n2. **Krok 2 (Inicjalizacja Union-Find):** Każdy wierzchołek tworzy własne jednoelementowe drzewo: `{A}, {B}, {C}, {D}`.\n3. **Krok 3 (Krawędź A-B, waga 1):** Sprawdzamy reprezentantów. A i B są w osobnych zbiorach. Budujemy połączenie i dodajemy krawędź do MST. Łączymy zbiory: `{A, B}, {C}, {D}`.\n4. **Krok 4 (Krawędź A-C, waga 2):** Sprawdzamy reprezentantów. Zbiór A to `{A, B}`, zbiór C to `{C}` (są różne). Dodajemy krawędź do MST. Łączymy: `{A, B, C}, {D}`.\n5. **Krok 5 (Krawędź B-C, waga 3):** Sprawdzamy reprezentantów. Zarówno B, jak i C należą do zjednoczonego zbioru `{A, B, C}`. Odrzucamy krawędź B-C, aby nie dopuścić do utworzenia cyklu (pętli A-B-C-A).\n6. **Krok 6 (Krawędź C-D, waga 4):** Sprawdzamy reprezentantów. `{A, B, C}` oraz `{D}` są różne. Dodajemy krawędź do MST. Łączymy: `{A, B, C, D}`.\n7. **Koniec:** Wszystkie wierzchołki należą do jednego spójnego zbioru. Otrzymaliśmy MST składające się z krawędzi `[A-B, A-C, C-D]` o łącznej wadze `1 + 2 + 4 = 7`.\n\nDo błyskawicznego sprawdzania przynależności do drzew oraz ich scalania stosuje się strukturę danych zbiorów rozłącznych (Union-Find) z kompresją ścieżek.\n\nZłożoność obliczeniowa wynosi O(E log E) lub O(E log V) – co jest zdominowane przez etap sortowania krawędzi. Sam proces łączenia wierzchołków przy użyciu Union-Find jest niemal natychmiastowy.",
...
for edge(u, v):
  ...
  prim: {
    ...
    theory_pl:
      "Algorytm Prima to kolejny zachłanny algorytm służący do wyznaczania Minimalnego Drzewa Rozpinającego (MST) w spójnym, ważonym grafie nieskierowanym. Choć pierwotnie został odkryty przez czeskiego matematyka Vojtěcha Jarníka w 1930 roku, został spopularyzowany niezależnie przez Roberta Prima w 1957 roku oraz Edsgera Dijkstrę w 1959 roku.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy ten sam graf z wierzchołkami `A, B, C, D` i krawędziami: `A-B (1), A-C (2), B-C (3), C-D (4), B-D (5)`. Startujemy z wierzchołka **A**:\n1. **Krok 1:** Dodajemy wierzchołek `A` do drzewa MST. `MST_nodes = {A}`. Potencjalne krawędzie graniczne łączące MST z resztą to: `A-B (waga 1)` oraz `A-C (waga 2)`.\n2. **Krok 2:** Wybieramy najkrótszą krawędź graniczną -> `A-B (1)`. Dodajemy wierzchołek `B` do drzewa. `MST_nodes = {A, B}`. Użyta krawędź: `A-B`.\n3. **Krok 3:** Aktualizujemy krawędzie graniczne. Nowe połączenia to: `A-C (2)`, `B-C (3)`, `B-D (5)`. Wybieramy najkrótszą z nich -> `A-C (2)`. Dodajemy wierzchołek `C` do drzewa. `MST_nodes = {A, B, C}`. Użyta krawędź: `A-C`.\n4. **Krok 4:** Aktualizujemy krawędzie graniczne. Połączenie `B-C` odpada, bo oba wierzchołki są już w drzewie. Nowe aktywne krawędzie to: `C-D (4)`, `B-D (5)`. Najkrótsza to `C-D (4)`. Dodajemy wierzchołek `D` do drzewa. `MST_nodes = {A, B, C, D}`. Użyta krawędź: `C-D`.\n5. **Koniec:** Wszystkie wierzchołki znajdują się w MST. Minimalne drzewo rozpinające składa się z krawędzi `[A-B, A-C, C-D]` o łącznej wadze `7`.\n\nW przeciwieństwie do algorytmu Kruskala, który buduje MST, łącząc losowe krawędzie w całym grafie, algorytm Prima „rozrasta” jedno spójne drzewo krok po kroku, zaczynając od jednego, dowolnie wybranego wierzchołka startowego.\n\nZłożoność obliczeniowa przy użyciu kopca binarnego wynosi O(E log V). Jest to algorytm niezwykle wydajny w przypadku grafów gęstych.",
    history:
  ...
  "topo-sort": {
    ...
    theory_pl:
      "Sortowanie topologiczne to liniowe uporządkowanie wierzchołków w skierowanym grafie acyklicznym (DAG - Directed Acyclic Graph) w taki sposób, że dla każdej krawędzi skierowanej prowadzącej od wierzchołka u do wierzchołka v, u znajduje się przed v w uporządkowaniu. Jeśli graf zawiera choć jeden cykl, sortowanie topologiczne jest niemożliwe do wykonania.\n\n**Analiza przykładu (Krok po kroku przy użyciu algorytmu Kahna):**\nRozważmy graf skierowany opisujący kolejność ubierania ubrań z wierzchołkami `Skarpetki, Buty, Bielizna, Spodnie` i krawędziami skierowanymi (zależnościami):\n- `Skarpetki -> Buty` (musisz założyć skarpetki przed butami)\n- `Bielizna -> Spodnie`\n- `Spodnie -> Buty`\n\n1. **Inicjalizacja (Stopnie wejściowe):** Liczymy, ile krawędzi wchodzi do każdego wierzchołka:\n   - `Skarpetki`: 0\n   - `Bielizna`: 0\n   - `Spodnie`: 1 (od Bielizny)\n   - `Buty`: 2 (od Skarpetek i od Spodni)\n2. **Krok 1:** Wybieramy wierzchołki ze stopniem wejściowym 0 (brak zależności). Mamy do wyboru `Skarpetki` i `Bielizna`. Wybieramy `Skarpetki`, dodajemy do wyniku: `[Skarpetki]`. Usuwamy krawędź `Skarpetki -> Buty` i aktualizujemy stopnie sąsiadów: stopień `Buty` spada z 2 do 1.\n3. **Krok 2:** Jedynym pozostałym wierzchołkiem o stopniu 0 jest `Bielizna`. Dodajemy ją do wyniku: `[Skarpetki, Bielizna]`. Usuwamy krawędź `Bielizna -> Spodnie` -> stopień `Spodnie` spada do 0.\n4. **Krok 3:** Nowym wierzchołkiem bez zależności (stopień 0) staje się `Spodnie`. Dodajemy do wyniku: `[Skarpetki, Bielizna, Spodnie]`. Usuwamy krawędź `Spodnie -> Buty` -> stopień `Buty` spada do 0.\n5. **Krok 4:** Ostatnim wierzchołkiem ze stopniem 0 staje się `Buty`. Dodajemy do wyniku: `[Skarpetki, Bielizna, Spodnie, Buty]`. Zbiór wierzchołków pusty.\n   - Otrzymaliśmy w pełni poprawne i bezpieczne uporządkowanie zadań!\n\nZłożoność czasowa wynosi O(V + E), a złożoność pamięciowa to O(V). Sortowanie topologiczne jest kluczowym narzędziem w systemach budowania oprogramowania (np. make, webpack), harmonogramowaniu zadań z zależnościami czy w silnikach bazodanowych.",
    history:
...
push to stack after visiting neighbors`,
  ...
  binary: {
    ...
    theory_pl:
      "Drzewo binarne to jedna z najważniejszych i najbardziej fundamentalnych struktur danych w informatyce. Składa się z węzłów (nodes), gdzie każdy posiada wartość oraz wskaźniki do maksymalnie dwóch potomków (lewego i prawego dziecka).\n\n**Analiza przykładu (Drzewo Wyrażeń Matematycznych):**\nWizualizowany przykład reprezentuje drzewo dla wyrażenia `A + (B * C)` o następującej strukturze:\n- Węzeł główny (korzeń): `+` (node-root)\n- Lewe dziecko korzenia: `A` (node-A)\n- Prawe dziecko korzenia: `*` (node-mul)\n- Lewe dziecko `*`: `B` (node-B)\n- Prawe dziecko `*`: `C` (node-C)\n\nPrzechodzenie tego drzewa (traversals) realizowane jest w trzech trybach, dających unikalne wyniki matematyczne:\n1. **Pre-order (Korzeń -> Lewo -> Prawo):** Najpierw odwiedzamy rodzica, potem jego lewe i prawe poddrzewo. Kolejność: `+`, `A`, `*`, `B`, `C` (tzw. notacja przedrostkowa / polska).\n2. **In-order (Lewo -> Korzeń -> Prawo):** Wchodzimy najgłębiej w lewo, potem rodzic, potem w prawo. Kolejność: `A`, `+`, `B`, `*`, `C`. Odwzorowuje to klasyczny zapis matematyczny z nawiasami.\n3. **Post-order (Lewo -> Prawo -> Korzeń):** Najpierw dzieci (lewe, potem prawe), na końcu ich rodzic. Kolejność: `A`, `B`, `C`, `*`, `+` (odwrotna notacja polska - RPN, używana w kompilatorach i kalkulatorach do łatwego wykonywania działań bez użycia nawiasów).",
    history:
  ...
  bst: {
    ...
    theory_pl:
      "Binarne drzewo poszukiwań (BST) to uporządkowana struktura, w której dla każdego węzła zachodzi warunek: wszystkie elementy w lewym poddrzewie są mniejsze, a w prawym większe lub równe jego wartości.\n\n**Analiza przykładu (Krok po kroku):**\nPrzykład buduje drzewo wstawiając po kolei liczby: `[15, 10, 20, 8, 12, 17, 25]`:\n1. **Wstawianie 15:** Drzewo jest puste, więc `15` staje się korzeniem głównym.\n2. **Wstawianie 10:** Porównujemy z `15`. Ponieważ `10 < 15`, idziemy w lewo. Pozycja lewa jest wolna, więc `10` staje się lewym dzieckiem `15`.\n3. **Wstawianie 20:** Porównujemy z `15`. Ponieważ `20 > 15`, idziemy w prawo. Staje się prawym dzieckiem `15`.\n4. **Wstawianie 8:** Porównujemy z `15` (w lewo do `10`), potem z `10` (`8 < 10`, w lewo). Staje się lewym dzieckiem `10`.\n5. **Wstawianie 12:** Porównujemy z `15` (w lewo do `10`), potem z `10` (`12 > 10`, w prawo). Staje się prawym dzieckiem `10`.\n6. **Wstawianie 17:** Porównujemy z `15` (w prawo do `20`), potem z `20` (`17 < 20`, w lewo). Staje się lewym dzieckiem `20`.\n7. **Wstawianie 25:** Porównujemy z `15` (w prawo do `20`), potem z `20` (`25 > 20`, w prawo). Staje się prawym dzieckiem `20`.\n\nDzięki temu, że elementy są wstawiane w tej kolejności, otrzymujemy idealnie zbalansowane drzewo o wysokości 3. Czas wyszukiwania dowolnej liczby wynosi maksymalnie 3 porównania (O(log n)).",
    history:
  ...
  avl: {
    ...
    theory_pl:
      "Drzewo AVL to samobalansujące się drzewo BST, w którym wysokość lewego i prawego poddrzewa każdego węzła różni się o co najwyżej 1. W przypadku wykrycia różnicy (współczynnik wyważenia = -2 lub 2), wykonywana jest rotacja.\n\n**Analiza przykładu (Krok po kroku):**\nWizualizacja wstawia liczby `[10, 20, 30, 40, 50, 25]`:\n1. **Wstawianie 10 i 20:** `10` (korzeń), `20` (prawe dziecko). Drzewo jest stabilne.\n2. **Wstawianie 30:** Trafia na prawo od `20`. Powstaje ścieżka skręcona w prawo `10 -> 20 -> 30`. Współczynnik wyważenia `10` wynosi `-2` (unbalanced). Wykonywana jest **Rotacja w lewo (Left) na 10**. Węzeł `20` staje się nowym korzeniem z lewym dzieckiem `10` i prawym `30`.\n3. **Wstawianie 40 i 50:** `40` trafia na prawo od `30`, a `50` na prawo od `40`. Drzewo przy `30` staje się skrajnie prawostronne `30 -> 40 -> 50`. Wykonywana jest **Rotacja w lewo (Left) na 30**. Węzeł `40` staje się rodzicem dla `30` i `50`.\n4. **Wstawianie 25:** Przechodzi przez `20` (w prawo), `40` (w lewo), `30` (w lewo) i staje się lewym dzieckiem `30`. Wysokości poddrzew korzenia `20` wynoszą odpowiednio: lewe = 1 (`10`), prawe = 3 (`40` z dziećmi). Różnica wynosi `-2`. Prawa strona jest zbyt ciężka, a jej poddrzewo (`40`) jest lewostronne (RL). Wykonywana jest najpierw **Rotacja w prawo na elemencie 40**, a następnie **Rotacja w lewo na elemencie 20** wokół nowego wierzchołka `30`, przywracając idealny balans całego drzewa.",
  ...
  rbt: {
    ...
    theory_pl:
      "Drzewo czerwono-czarne (RBT) to samobilansujące się drzewo BST, w którym każdy węzeł ma kolor czerwony lub czarny. Balans jest zachowywany poprzez restrykcyjne reguły (np. brak dwóch czerwonych węzłów pod rząd, równa czarna wysokość).\n\n**Analiza przykładu (Krok po kroku):**\nWizualizacja wstawia po kolei elementy `[10, 20, 30, 40, 50, 25]`:\n1. **Wstawianie 10:** Dodawane jako czerwony korzeń, a następnie automatycznie przemalowywane na czarno (reguła 2).\n2. **Wstawianie 20:** Wstawiane jako czerwony prawy syn `10`.\n3. **Wstawianie 30:** Wstawiane na prawo od `20` jako czerwony węzeł. Powstaje konflikt: czerwony `20` ma czerwonego syna `30`. Ponieważ wujek `30` (lewy syn `10`) jest czarny/NIL, a ścieżka jest liniowa w prawo, wykonujemy **Rotację w lewo na 10** oraz zamieniamy kolory: `20` staje się czarnym korzeniem, a `10` i `30` czerwonymi dziećmi.\n4. **Wstawianie 40:** Dodawany jako czerwony prawy syn `30`. Wujek `40` (`10`) jest czerwony. Wykonujemy **Przemalowywanie (Recoloring)**: `30` i `10` stają się czarne, a ich rodzic `20` czerwony (który jako korzeń jest od razu przemalowywany na czarno).\n5. **Wstawianie 50:** Dodawany jako czerwony syn `40`. Wykryto konflikt czerwony-czerwony (`40`-`50`). Wujek `50` (lewe dziecko `30` - NIL) jest czarny. Wykonujemy **Rotację w lewo na elemencie 30** oraz recoloring, co podnosi czarnego rodzica wyżej.\n6. **Wstawianie 25:** Wstawiane na lewo od `30`, wywołując kaskadę rotacji i przemalowań, co chroni drzewo przed nadmiernym wydłużeniem gałęzi.",
    history:
  ...
  trie: {
    ...
    theory_pl:
      "Drzewo Trie (prefiksowe) służy do optymalnego przechowywania wyrazów. Wierzchołki reprezentują pojedyncze litery, a ścieżka od korzenia do węzła z flagą 'końca słowa' (end-of-word) tworzy pełne słowo.\n\n**Analiza przykładu (Wstawianie słów):**\nWizualizacja wstawia kolejno wyrazy: `[\"cat\", \"car\", \"dog\"]`:\n1. **Wstawianie \"cat\":** Korzeń początkowo nie posiada żadnego potomka. Wstawiamy literę `'c'` pod korzeń, następnie `'a'` pod `'c'`, a na końcu `'t'` pod `'a'`. Węzeł `'t'` jest oznaczany jako koniec słowa (zabarwia się na zielono).\n2. **Wstawianie \"car\":** Algorytm przechodzi od korzenia i zauważa, że litera `'c'` już istnieje. Schodzi do `'c'`. Następnie widzi, że `'a'` również już istnieje pod `'c'`. Schodzi do `'a'`. Na koniec sprawdza `'r'`. Ponieważ `'r'` nie istnieje pod `'a'`, tworzony jest nowy węzeł `'r'` z flagą końca słowa. Zwróć uwagę, że słowa \"cat\" i \"car\" współdzielą wspólny przedrostek (prefiks) **\"ca\"**, co pozwala zaoszczędzić pamięć komputerową!\n3. **Wstawianie \"dog\":** Algorytm wraca do korzenia. Litera `'d'` nie istnieje pod korzeniem, więc tworzy nową gałąź dla wyrazu: `'d'` ➔ `'o'` ➔ `'g'` (węzeł `'g'` zostaje oznaczony jako koniec słowa).",
    history:
  ...
  knapsack: {
    ...
    theory_pl:
      "Problem plecakowy 0/1 (0/1 Knapsack Problem) to klasyczne zagadnienie optymalizacji kombinatorycznej. Mając dany zestaw przedmiotów, z których każdy ma przypisaną wagę oraz wartość, oraz plecak o ograniczonym udźwigu, należy wybrać taki podzbiór przedmiotów, aby ich łączna wartość była maksymalna, a suma wag nie przekraczała pojemności plecaka. Określenie „0/1” oznacza, że każdy przedmiot jest niepodzielny – możemy go wziąć w całości (1) lub całkowicie go zostawić (0).\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy plecak o pojemności **W = 5 kg** oraz 3 unikalne przedmioty:\n- Przedmiot 1: waga `2 kg`, wartość `3 zł`\n- Przedmiot 2: waga `3 kg`, wartość `4 zł`\n- Przedmiot 3: waga `4 kg`, wartość `5 zł`\n\nTworzymy tablicę `DP` o rozmiarze 4x6 (wiersze 0-3 odpowiadają przedmiotom, kolumny 0-5 dopuszczalnym pojemnościom plecaka). Początkowo wiersz 0 (brak przedmiotów) i kolumna 0 (plecak 0kg) są wypełnione zerami:\n1. **Wstawiamy Przedmiot 1 (waga 2, wartość 3):**\n   - Dla wag 0 i 1: nie mieści się, przepisujemy `0`.\n   - Dla wag 2, 3, 4, 5: mieści się, wpisujemy wartość `3`.\n   - Wiersz DP dla przedmiotu 1: `[0, 0, 3, 3, 3, 3]`.\n2. **Wstawiamy Przedmiot 2 (waga 3, wartość 4):**\n   - Dla wag 0, 1, 2: dziedziczymy wartości wyżej: `0`, `0`, `3`.\n   - Dla wagi 3: `max(DP[nad][3], 4 + DP[nad][0]) = max(3, 4 + 0) = 4`.\n   - Dla wagi 4: `max(DP[nad][4], 4 + DP[nad][1]) = max(3, 4 + 0) = 4`.\n   - Dla wagi 5: `max(DP[nad][5], 4 + DP[nad][2]) = max(3, 4 + 3) = 7` (bierzemy przedmiot 1 i przedmiot 2!).\n   - Wiersz DP dla przedmiotu 2: `[0, 0, 3, 4, 4, 7]`.\n3. **Wstawiamy Przedmiot 3 (waga 4, wartość 5):**\n   - Dla wag 0, 1, 2, 3: dziedziczymy: `0`, `0`, `3`, `4`.\n   - Dla wagi 4: `max(DP[nad][4], 5 + DP[nad][0]) = max(4, 5 + 0) = 5`.\n   - Dla wagi 5: `max(DP[nad][5], 5 + DP[nad][1]) = max(7, 5 + 0) = 7`.\n   - Wiersz DP dla przedmiotu 3: `[0, 0, 3, 4, 5, 7]`.\n\nMaksymalna wartość, jaką możemy spakować do plecaka, wynosi **7 zł** (wybierając Przedmiot 1 i 2 o łącznej wadze 5 kg).\n\nProblem ten należy do klasy problemów NP-trudnych. Jednak za pomocą programowania dynamicznego (Dynamic Programming - DP), wprowadzonego przez Richarda Bellmana w latach 50. XX wieku, możemy go rozwiązać w czasie pseudowielomianowym przy użyciu tablicy pamięci podręcznej.\n\nZłożoność obliczeniowa tego podejścia wynosi O(N * W), a złożoność pamięciowa to również O(N * W) (którą można zoptymalizować do O(W) przy użyciu jednowymiarowej tablicy).",
    history:
  ...
  lcs: {
    ...
    theory_pl:
      "Problem Najdłuższego Wspólnego Podciągu (Longest Common Subsequence - LCS) to klasyczne zagadnienie teorii sekwencji i algorytmiki. Celem jest znalezienie podciągu o maksymalnej długości, który występuje w dwóch zadanych ciągach znaków (tekstach) w tej samej względnej kolejności, przy czym elementy podciągu nie muszą sąsiadować bezpośrednio ze sobą (w przeciwieństwie do wspólnego spójnego fragmentu tekstu - substring).\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy dwa teksty: **X = \"ABCBDAB\"** (długość 7) oraz **Y = \"BDCABA\"** (długość 6). Tworzymy tablicę `DP` o wymiarach 8x7, gdzie `DP[i][j]` przechowuje długość LCS dla podciągów `X[0..i-1]` oraz `Y[0..j-1]`:\n1. Inicjalizujemy pierwszy wiersz i kolumnę zerami (reprezentującymi puste teksty).\n2. Iterujemy komórka po komórce porównując znaki:\n   - Jeśli `X[i-1] == Y[j-1]`: zwiększamy wartość o 1 względem przekątnej z lewej-góry: `DP[i][j] = DP[i-1][j-1] + 1`.\n   - Jeśli `X[i-1] != Y[j-1]`: bierzemy maksimum z sąsiedniej komórki z góry lub z lewej: `DP[i][j] = max(DP[i-1][j], DP[i][j-1])`.\n3. Przykład przejścia dla liter:\n   - Dla `X[1]=\"A\"` i `Y[1]=\"B\"` -> różne -> `max(0,0) = 0`.\n   - Dla `X[2]=\"B\"` i `Y[1]=\"B\"` -> zgodność! -> `DP[2][1] = DP[1][0] + 1 = 1`.\n   - Dla `X[3]=\"C\"` i `Y[3]=\"C\"` -> zgodność! -> `DP[3][3] = DP[2][2] + 1 = 2`.\n4. Po wypełnieniu całej tablicy, w prawym dolnym rogu `DP[7][6]` otrzymamy wartość **4**.\n5. Odtwarzając drogę powrotną od końca (idąc na ukos za każdym razem, gdy znaki są równe), rekonstruujemy najdłuższy wspólny podciąg: **\"BDAB\"** o długości 4.\n\nZłożoność obliczeniowa i pamięciowa algorytmu wynosi O(M * N). Algorytm ten jest absolutnym fundamentem działania programów do porównywania plików tekstowych (narzędzia typu diff oraz systemy kontroli wersji, np. git diff), a także odgrywa kluczową rolę w bioinformatyce.",
    history:
  ...
  "flood-fill": {
    ...
    theory_pl:
      "Algorytm Flood Fill (wypełnianie zalewowe), potocznie nazywany algorytmem wiadra z farbą, służy do wyznaczania i transformacji spójnych obszarów w wielowymiarowych strukturach danych, najczęściej w dwuwymiarowych siatkach pikseli. Jest to bezpośrednia adaptacja algorytmów przeszukiwania grafów – BFS lub DFS.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy małą siatkę pikseli 3x3. Wszystkie komórki są białe (`W`), za wyjątkiem linii blokującej wiersza 1 na koordynatach `(1,0)` i `(1,1)`, która jest czarną barierą (`B`):\n- Row 0: `[W, W, W]`\n- Row 1: `[B, B, W]`\n- Row 2: `[W, W, W]`\n\nChcemy uruchomić Flood Fill od punktu startowego **(0,0)** z kolorem docelowym **Czerwonym (R)**:\n1. **Krok 1:** Zaczynamy w `(0,0)`. Ponieważ jest biały, przemalowujemy go na czerwono. `(0,0) = R`. Sprawdzamy jego sąsiadów: dół `(1,0)` i prawo `(0,1)`.\n2. **Krok 2:** Sąsiad z dołu `(1,0)` to czarna bariera `B` -> ignorujemy go. Przechodzimy do sąsiada z prawej `(0,1)`. Jest biały, więc malujemy na czerwono. `(0,1) = R`. Sprawdzamy sąsiadów `(0,1)`: prawo `(0,2)` oraz dół `(1,1)` (B).\n3. **Krok 3:** Przechodzimy do `(0,2)`. Malujemy na czerwono. `(0,2) = R`. Jedynym wolnym niepomalowanym sąsiadem jest dół `(1,2)` (biały).\n4. **Krok 4:** Przechodzimy do `(1,2)` (ominięcie bariery od prawej strony!). Malujemy na czerwono. `(1,2) = R`. Sprawdzamy sąsiadów: dół `(2,2)` (biały).\n5. **Krok 5:** Przechodzimy do `(2,2)`. Malujemy na czerwono. `(2,2) = R`. Sprawdzamy sąsiadów: lewo `(2,1)` (biały).\n6. **Krok 6:** Przechodzimy do `(2,1)`. Malujemy na czerwono. `(2,1) = R`. Sprawdzamy sąsiadów: lewo `(2,0)` (biały).\n7. **Krok 7:** Przechodzimy do `(2,0)`. Malujemy na czerwono. `(2,0) = R`.\n8. **Koniec:** Wszystkie spójne, białe komórki zostały pomyślnie zamalowane na czerwono, sprytnie obchodząc czarną linię graniczną.\n\nWersja rekurencyjna (DFS) cechuje się prostotą kodu, lecz przy bardzo dużych obrazach grozi przepełnieniem stosu (stack overflow). Wersje produkcyjne zazwyczaj korzystają z kolejki (BFS) i optymalizacji linia-po-linii (scanline flood fill). Złożoność obliczeniowa wynosi O(N), gdzie N to liczba pikseli w spójnym obszarze, a złożoność pamięciowa to O(N) na utrzymanie struktur sterujących.",
    history:
  ...
  "max-heap": {
    ...
    theory_pl:
      "Kopiec typu Max (Max-Heap) to wysoce wyspecjalizowana, drzewiasta struktura danych spełniająca warunek kopca. Jest to kompletne drzewo binarne, w którym wartość każdego węzła będącego rodzicem jest większa lub równa wartościom jego węzłów potomnych (dzieci). W rezultacie element o największej wartości w całym kopcu zawsze znajduje się w korzeniu drzewa (indeks 0 w reprezentacji tablicowej).\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy wstawianie po kolei elementów `[10, 20, 15, 30]` do pustego kopca:\n1. **Wstawianie 10:** Kopiec jest pusty, element staje się korzeniem głównym na indeksie 0 tablicy. Tablica kopca: `[10]`.\n2. **Wstawianie 20:** Wstawiamy element na pierwsze wolne miejsce na końcu (lewe dziecko korzenia, indeks 1). Tablica: `[10, 20]`. Następuje naruszenie warunku kopca (`20 > 10`). Wykonujemy operację **bubble-up** (przesunięcie w górę): zamieniamy `10` i `20`. Tablica po zamianie: `[20, 10]`.\n3. **Wstawianie 15:** Wstawiamy element na koniec (prawe dziecko korzenia, indeks 2). Tablica: `[20, 10, 15]`. Ponieważ `15` jest mniejsze od swojego rodzica `20`, warunek kopca jest spełniony. Brak zamian.\n4. **Wstawianie 30:** Wstawiamy element na koniec (lewe dziecko węzła `10`, indeks 3). Tablica: `[20, 10, 15, 30]`. Sprawdzamy rodzica pod adresem `floor((3-1)/2) = 1` (wartość `10`). Ponieważ `30 > 10`, wykonujemy **bubble-up** i zamieniamy je. Tablica: `[20, 30, 15, 10]`.\n   - Teraz nowym rodzicem dla `30` (indeks 1) jest korzeń `20` (indeks 0). Ponieważ `30 > 20`, wykonujemy kolejną zamianę w górę. Tablica: `[30, 20, 15, 10]`.\n   - Element `30` osiągnął korzeń. Kopiec jest zbalansowany i spełnia wszystkie założenia!\n\nKopce są powszechnie implementowane za pomocą zwykłych tablic jednowymiarowych, co eliminuje narzut pamięciowy na wskaźniki lewego/prawego dziecka. Relacje rodzic-dziecko oblicza się matematycznie na indeksach:\n- Lewe dziecko węzła o indeksie i znajduje się pod adresem 2*i + 1.\n- Prawe dziecko znajduje się pod adresem 2*i + 2.\n- Rodzic węzła o indeksie i znajduje się pod adresem floor((i-1)/2).\n\nPodstawowe operacje:\n1. Wstawianie (Insert): Nowy element umieszcza się na samym dole kopca (na końcu tablicy), a następnie przywraca się własności kopca, przesuwając element w górę (operacja bubble-up) poprzez sukcesywne zamiany z rodzicem, o ile rodzic jest mniejszy. Złożoność wynosi O(log n).\n2. Usunięcie maksimum (Extract-Max): Usumuwamy korzeń, na jego miejsce wstawiamy ostatni element z dołu kopca i spychamy go w dół (operacja sift-down), zamieniając z większym z dzieci. Złożoność wynosi O(log n).",
    history:
  ...
  "union-find": {
    ...
    theory_pl:
      "Struktura zbiorów rozłącznych (Disjoint-Set), powszechnie nazywana algorytm Union-Find, to niezwykle wydajna struktura danych służąca do reprezentowania i zarządzania podziałem skończonego zbioru elementów na rozłączne podzbiory. Została zaproponowana przez Bernarda Gallera i Michaela Fischera w 1964 roku.\n\n**Analiza przykładu (Krok po kroku):**\nRozważmy zbiór czterech elementów `{0, 1, 2, 3}`. Na początku każdy element tworzy osobną grupę i wskazuje na samego siebie: `parent = [0, 1, 2, 3]`, rangi wyważenia = `[0, 0, 0, 0]`:\n1. **Operacja Union(0, 1):**\n   - Wywołujemy `Find(0)` -> zwraca `0` (reprezentant).\n   - Wywołujemy `Find(1)` -> zwraca `1` (reprezentant).\n   - Rangi są równe, więc podczepiamy element `1` pod `0` (`parent[1] = 0`). Ranga `0` rośnie do 1. Stan: `parent = [0, 0, 2, 3]`.\n2. **Operacja Union(2, 3):**\n   - `Find(2)` -> `2`, `Find(3)` -> `3`.\n   - Rangi równe, podczepiamy `3` pod `2` (`parent[3] = 2`). Ranga `2` rośnie do 1. Stan: `parent = [0, 0, 2, 2]`.\n3. **Operacja Union(1, 3):**\n   - `Find(1)` przechodzi do rodzica `parent[1]` i zwraca głównego reprezentanta `0`.\n   - `Find(3)` przechodzi do rodzica `parent[3]` i zwraca głównego reprezentanta `2`.\n   - Łączymy reprezentantów `0` i `2`. Ponieważ ich rangi są równe (`1`), podczepiamy `2` pod `0` (`parent[2] = 0`). Stan: `parent = [0, 0, 0, 2]`.\n4. **Optymalizacja: Kompresja Ścieżki w Find(3):**\n   - Wywołujemy operację sprawdzenia grupy dla elementu `3`: `Find(3)`.\n   - Algorytm przechodzi ścieżkę: `3 -> rodzic 2 -> rodzic 0`.\n   - Ponieważ dotarliśmy do korzenia `0`, podczas powrotu z rekurencji wskaźnik rodzica węzła `3` jest bezpośrednio przepinany do korzenia `0`. `parent[3] = 0`.\n   - Stan po kompresji: `parent = [0, 0, 0, 0]`. Od teraz każde kolejne sprawdzenie elementu `3` potrwa tylko 1 krok (złożoność O(1))!\n\nWydajność Union-Find zależy od dwóch genialnych optymalizacji:\n- Kompresja ścieżek (Path Compression) w operacji Find: Podczas wyszukiwania reprezentanta, wskaźniki wszystkich odwiedzonych po drodze węzłów są przepinane bezpośrednio do głównego reprezentanta.\n- Unia według rangi (Union by Rank/Size): Podczas łączenia grup, mniejsze drzewo jest zawsze podczepiane pod korzeń większego drzewa, co zapobiega powstawaniu zbyt głębokich struktur.\n\nPrzy zastosowaniu obu tych optymalizacji, średni koszt każdej operacji wynosi niemal stałe O(α(n)), gdzie α to odwrotność funkcji Ackermanna.",
    history:
