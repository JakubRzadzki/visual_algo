...
export const ALGORITHM_EDUCATION: Record<string, AlgorithmEducation> = {
  "merge-sort": {
    ...
    theory_pl:
      'Sortowanie przez scalanie (Merge Sort) to stabilny algorytm typu "dziel i zwyciężaj". Dzieli tablicę na połowy, sortuje je rekurencyjnie, a następnie scala wyniki.',
    history:
    ...
    forDummies_pl:
      "To jak sortowanie talii kart poprzez dzielenie jej na coraz mniejsze stosy, a następnie łączenie ich w odpowiedniej kolejności.",
  ...
  "quick-sort": {
    ...
    theory_pl:
      "Sortowanie szybkie (Quick Sort) to wydajny algorytm oparty na porównaniach, wykorzystujący element osiowy (pivot) do podziału tablicy.",
    ...
    forDummies_pl:
      'Wybierasz "lidera" z tłumu. Niższe osoby stają po lewej stronie, a wyższe po prawej. Powtarzasz to dla obu grup.',
  ...
  "bubble-sort": {
    ...
    theory_pl:
      "Sortowanie bąbelkowe (Bubble Sort) to prosty algorytm, który wielokrotnie przechodzi przez listę, zamieniając sąsiednie elementy, jeśli są w złej kolejności.",
    history:
    ...
    forDummies_pl:
      'Największe liczby "wypływają" na koniec tablicy jak bąbelki w napoju gazowanym.',
  ...
  "heap-sort": {
    ...
    theory_pl:
      "Sortowanie przez kopcowanie (Heap Sort) wykorzystuje strukturę kopca binarnego do znajdowania największego elementu i przenoszenia go na koniec tablicy.",
    history:
    ...
    forDummies_pl:
      "Układasz ludzi w piramidę, gdzie najstarszy jest na szczycie. Zabierasz szefa, a piramidę układasz od nowa z pozostałych osób.",
  ...
  "binary-search": {
    ...
    theory_pl:
      "Wyszukiwanie binarne (Binary Search) efektywnie znajduje wartość w posortowanej tablicy poprzez wielokrotne dzielenie przedziału poszukiwań na pół.",
    history:
    ...
    forDummies_pl:
      'Szukasz słowa w papierowym słowniku. Otwierasz na środku i decydujesz: "moje słowo jest wcześniej czy później?". Połówkę, która Cię nie interesuje, odrzucasz.',
  ...
  "linear-search": {
    ...
    theory_pl:
      "Wyszukiwanie liniowe (Linear Search) sprawdza każdy element listy po kolei, aż znajdzie cel lub dojdzie do końca listy.",
    history:
    ...
    forDummies_pl:
      "Szukasz konkretnej skarpetki w stercie prania, sprawdzając każdą po kolei, dopóki nie znajdziesz tej właściwej.",
...
return -1`,
  ...
  dijkstra: {
    ...
    theory_pl:
      "Algorytm Dijkstry znajduje najkrótszą ścieżkę między węzłami w grafie ważonym o nieujemnych wagach krawędzi.",
    history:
    ...
    forDummies_pl:
      "Szukasz najszybszej drogi do celu. Sprawdzasz wszystkie możliwe skrzyżowania, zaczynając od tych położonych najbliżej Ciebie.",
  ...
  bfs: {
    ...
    theory_pl:
      "Przeszukiwanie wszerz (BFS) odwiedza wszystkich sąsiadów danego węzła, zanim przejdzie do kolejnego poziomu.",
    history:
    ...
    forDummies_pl:
      "To jak fala rozchodząca się po wodzie. Najpierw sprawdzasz wszystko, co jest tuż obok, a potem idziesz coraz dalej.",
...
while queue:
  ...
  dfs: {
    ...
    theory_pl:
      "Przeszukiwanie w głąb (DFS) idzie tak daleko, jak to możliwe wzdłuż każdej gałęzi, zanim zacznie się cofać.",
    history:
    ...
    forDummies_pl:
      "Idziesz przez labirynt tak długo, aż uderzysz w ścianę, a potem wracasz do ostatniego rozwidlenia i sprawdzasz inną drogę.",
  ...
  "a-star": {
    ...
    theory_pl:
      "Algorytm A* to metoda wyszukiwania ścieżki, która używa heurystyki (inteligentnego zgadywania), aby szybciej dotrzeć do celu.",
    history:
    ...
    forDummies_pl:
      "To jak szukanie drogi z kompasem. Nie sprawdzasz wszystkiego na oślep, tylko idziesz tam, gdzie wydaje się, że jest najbliżej do celu.",
...
while openList:
  ...
  kruskal: {
    ...
    theory_pl:
      "Algorytm Kruskala znajduje Minimalne Drzewo Rozpinające, sortując wszystkie krawędzie i dodając te najtańsze, które nie tworzą cyklu.",
    ...
    forDummies_pl:
      "Chcesz połączyć wyspy mostami jak najtaniej. Wybierasz najtańsze możliwe połączenia, uważając, by nie budować mostów tam, gdzie już można dojechać inną drogą.",
...
for edge(u, v):
  ...
  prim: {
    ...
    theory_pl:
      'Algorytm Prima znajduje Minimalne Drzewo Rozpinające, "rozrastając" jedno drzewo od wybranego wierzchołka startowego.',
    history:
    ...
    forDummies_pl:
      "Budujesz sieć energetyczną. Zaczynasz od jednego domu i zawsze podłączasz ten, który jest najbliżej już istniejącej sieci.",
  ...
  "topo-sort": {
    ...
    theory_pl:
      "Sortowanie topologiczne to liniowe układanie wierzchołków grafu skierowanego bez cykli (DAG) zgodnie z ich zależnościami.",
    history:
    ...
    forDummies_pl:
      "To jak robienie listy zadań, gdzie niektóre rzeczy muszą być zrobione przed innymi (np. musisz założyć skarpetki przed butami).",
...
push to stack after visiting neighbors`,
  ...
  binary: {
    ...
    theory_pl:
      "Drzewo binarne to struktura danych, w której każdy węzeł ma co najwyżej dwoje dzieci: lewe i prawe.",
    history:
    ...
    forDummies_pl:
      "To drzewo genealogiczne, w którym każda osoba może mieć maksymalnie dwoje dzieci.",
  ...
  bst: {
    ...
    theory_pl:
      "Binarne drzewo poszukiwań (BST) przechowuje dane w porządku: mniejsze wartości idą na lewo, większe na prawo.",
    history:
    ...
    forDummies_pl:
      "To szafka z dokumentami. Jeśli szukasz numeru 50, a na środku jest 100, wiesz, że musisz szukać tylko po lewej stronie.",
  ...
  avl: {
    ...
    theory_pl:
      "Drzewo AVL to samobalansujące się drzewo BST, w którym różnica wysokości poddrzew wynosi maksymalnie jeden.",
    ...
    forDummies_pl:
      'To drzewo, które samo dba o to, by nie być zbyt "krzywym". Jeśli jedna strona robi się za długa, drzewo wykonuje "obrót", żeby się wyrównać.',
  ...
  rbt: {
    ...
    theory_pl:
      'Drzewo czerwono-czarne to samobalansujące się drzewo BST, które używa "kolorów" węzłów, aby utrzymać równowagę.',
    history:
    ...
    forDummies_pl:
      "To drzewo z regułami jak w sygnalizacji świetlnej. Kolory pomagają pilnować, żeby żadna ścieżka nie była zbyt długa.",
  ...
  trie: {
    ...
    theory_pl:
      "Drzewo Trie (prefiksowe) to struktura służąca do przechowywania tekstów, gdzie wspólne początki słów (prefiksy) są współdzielone.",
    history:
    ...
    forDummies_pl:
      'To jak autouzupełnianie w telefonie. Słowa są ułożone literka po literce na gałęziach. Żeby znaleźć "KOT", idziesz gałęzią K, potem O, potem T.',
  ...
  knapsack: {
    ...
    theory_pl:
      "Problem plecakowy 0/1 znajduje najwyższą wartość przedmiotów mieszczących się w limicie wagowym przy użyciu programowania dynamicznego.",
    history:
    ...
    forDummies_pl:
      "Jesteś włamywaczem z torbą o limicie 20 kg. Musisz zdecydować, co zabrać, aby łup był jak najdroższy, nie rozrywając przy tym torby.",
  ...
  lcs: {
    ...
    theory_pl:
      "Najdłuższy wspólny podciąg (LCS) znajduje najdłuższy ciąg znaków występujący w obu tekstach w tej samej względnej kolejności.",
    history:
    ...
    forDummies_pl:
      "Porównujesz listy filmów z kolegą i sprawdzasz, jaka jest najdłuższa seria tytułów, która pojawia się w obu listach w tej samej kolejności.",
  ...
  "flood-fill": {
    ...
    theory_pl:
      'Algorytm Flood Fill wyznacza spójne obszary w siatce; używany w narzędziach typu "wiadro z farbą" w edytorach graficznych.',
    history:
    ...
    forDummies_pl:
      "To jak rozlanie farby w programie Paint. Klikasz w jedno miejsce, a farba rozlewa się, dopóki nie napotka granicy innego koloru.",
  ...
  "max-heap": {
    ...
    theory_pl:
      "Kopiec typu Max to drzewo, w którym każdy rodzic jest większy lub równy swoim dzieciom, co gwarantuje, że maksimum jest w korzeniu.",
    history:
    ...
    forDummies_pl:
      'To drabina korporacyjna. Szef jest na samej górze, a każdy kierownik jest "ważniejszy" od swoich bezpośrednich podwładnych.',
  ...
  "union-find": {
    ...
    theory_pl:
      "Struktura zbiorów rozłącznych (Union-Find) śledzi grupy elementów i pozwala na ich błyskawiczne łączenie oraz sprawdzanie przynależności.",
    history:
    ...
    forDummies_pl:
      "To śledzenie grup znajomych na imprezie. Możesz błyskawicznie sprawdzić, czy dwie osoby należą do tej samej paczki.",
