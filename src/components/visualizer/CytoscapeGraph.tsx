 ...
 */
export default function CytoscapeGraph({ graph }: { graph: GraphInput }) {
      ...
      (event: VisualizationEvent) => {
        ...
        if (event.type === "TRACE_LOADED") {
          ...
          cyRef.current
            .elements()
            .removeClass(
              "highlight-visited highlight-relax highlight-accept highlight-reject",
            );
        ...
        if (event.isReverse) {
          if (event.type === "GRAPH_NODE_HIGHLIGHT" && event.nodeId) {
            ...
            (event.type === "GRAPH_EDGE_HIGHLIGHT" ||
              event.type === "GRAPH_RELAX") &&
            event.edgeId
          ) {
                ...
                edge.animate(
                  {
                    style: {
                      "line-color":
                        event.status === "backtrack" ? "#334155" : "#4b5563",
                      "target-arrow-color":
                        event.status === "backtrack" ? "#334155" : "#4b5563",
                      width: 2,
                    },
          ...
          stylesheet={[
            ...
            },
            {
              ...
              style: {
                ...
                "arrow-scale": 1.5,
                "target-arrow-shape":
                  (graph.isDirected ?? true) ? "triangle" : "none",
