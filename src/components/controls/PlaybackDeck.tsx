...
export default function PlaybackDeck() {
  ...
  return (
    <div data-tutorial-step="control-panel" className="absolute bottom-8 left-1/2 -translate-x-1/2 glass-panel-elevated px-8 py-3 flex items-center gap-6 z-50 transition-all duration-300 shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10 scale-90 sm:scale-100">
